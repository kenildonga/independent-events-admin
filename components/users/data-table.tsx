...
function DragHandle({ id, rowIndex }: { id: number; rowIndex: number }) {
...
export function DataTable({
    ...
    const filteredData = React.useMemo(() => {
        ...
        if (activeTab === "past-performance") return data.filter(item => item.status === "active")
        if (activeTab === "key-personnel") return data.filter(item => item.status === "inactive")
        if (activeTab === "focus-documents") return data.filter(item => item.status === "pending")
        return data
    }, [data, activeTab])
    ...
    const columns: ColumnDef<z.infer<typeof schema>>[] = [
        {
            id: "rowNumber",
            header: "#",
            cell: ({ row }) => <DragHandle id={row.original.id} rowIndex={row.index} />,
            enableSorting: false,
            enableHiding: false,
        },
        {
            ...
            <div className="flex items-center justify-between px-4 lg:px-6">
                ...
                <Select value={activeTab} onValueChange={setActiveTab}>
                    ...
                    <SelectContent>
                        ...
                        <SelectItem value="key-personnel">Inactive Users</SelectItem>
                        <SelectItem value="focus-documents">Pending Users</SelectItem>
                    </SelectContent>
                </Select>
